...
Black_King = pygame.transform.scale(pygame.image.load(os.path.join("chess_game/chess_images", "bQ.png")), (Square, Square))
Black_pawn = pygame.transform.scale(pygame.image.load(os.path.join("chess_game/chess_images", "bP.png")), (Square, Square))
Black_Queen = pygame.transform.scale(pygame.image.load(os.path.join("chess_game/chess_images", "bK.png")), (Square, Square))
...
White_King = pygame.transform.scale(pygame.image.load(os.path.join("chess_game/chess_images", "wQ.png")), (Square, Square))
White_pawn = pygame.transform.scale(pygame.image.load(os.path.join("chess_game/chess_images", "wp.png")), (Square, Square))
White_Queen = pygame.transform.scale(pygame.image.load(os.path.join("chess_game/chess_images", "wK.png")), (Square, Square))
